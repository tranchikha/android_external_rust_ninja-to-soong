...
enum mali_cs_opcode {
        ...
        MALI_CS_OPCODE_RUN_TILING            =      5,
        MALI_CS_OPCODE_RUN_IDVS              =      6,
...
mali_cs_opcode_as_str(enum mali_cs_opcode imm)
{
    ...
    case MALI_CS_OPCODE_RUN_TILING: return "RUN_TILING";
    case MALI_CS_OPCODE_RUN_IDVS: return "RUN_IDVS";
...
do { \
   ...
   __tmp_packed.opaque[ 0] = util_bitpack_uint((__unpacked)->wait_mask, 16, 23); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xff00ffff) fprintf(stderr, "XXX: Invalid field of CS WAIT unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0xfffffe) fprintf(stderr, "XXX: Invalid field of CS WAIT unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 23); \
...
MALI_CS_WAIT_print(FILE *fp, const struct MALI_CS_WAIT * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sProgress increment: %s\n", indent, "", values->progress_increment ? "true" : "false");
   fprintf(fp, "%*sOpcode: %s\n", indent, "", mali_cs_opcode_as_str(values->opcode));
}
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xffff0000) fprintf(stderr, "XXX: Invalid field of CS RUN_COMPUTE unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0xff00fe) fprintf(stderr, "XXX: Invalid field of CS RUN_COMPUTE unpacked at word 1\n"); \
...
#define MALI_CS_RUN_TILING_header               \
   .progress_increment = false,  \
   .opcode = MALI_CS_OPCODE_RUN_TILING

#define MALI_CS_RUN_TILING_LENGTH 8
struct mali_cs_run_tiling_packed { uint32_t opaque[2]; };
#define MALI_CS_RUN_TILING_PACKED_T struct mali_cs_run_tiling_packed
#define MALI_CS_RUN_TILING_pack(__packed, __unpacked) \
do { \
   MALI_CS_RUN_TILING_PACKED_T __tmp_packed; \
...
#define MALI_CS_RUN_TILING_unpack(__packed, __unpacked) \
do { \
   MALI_CS_RUN_TILING_PACKED_T __tmp_packed = *(__packed); \
   if (__tmp_packed.opaque[1] & 0xff00fe) fprintf(stderr, "XXX: Invalid field of CS RUN_TILING unpacked at word 1\n"); \
...
#ifndef __OPENCL_VERSION__
static inline void
MALI_CS_RUN_TILING_print(FILE *fp, const struct MALI_CS_RUN_TILING * values, unsigned indent)
{
...
#endif
struct MALI_CS_RUN_IDVS {
   uint64_t                             flags_override;
   bool                                 progress_increment;
   bool                                 malloc_enable;
   bool                                 draw_id_register_enable;
   bool                                 varying_srt_select;
   bool                                 varying_fau_select;
   bool                                 varying_tsd_select;
   bool                                 fragment_srt_select;
   bool                                 fragment_tsd_select;
   uint32_t                             draw_id;
   enum mali_cs_opcode                  opcode;
};

#define MALI_CS_RUN_IDVS_header                 \
   .progress_increment = false,  \
   .opcode = MALI_CS_OPCODE_RUN_IDVS

#define MALI_CS_RUN_IDVS_LENGTH 8
struct mali_cs_run_idvs_packed { uint32_t opaque[2]; };
#define MALI_CS_RUN_IDVS_PACKED_T struct mali_cs_run_idvs_packed
#define MALI_CS_RUN_IDVS_pack(__packed, __unpacked) \
do { \
   MALI_CS_RUN_IDVS_PACKED_T __tmp_packed; \
   __tmp_packed.opaque[ 0] = util_bitpack_uint((__unpacked)->flags_override, 0, 31); \
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->progress_increment, 0, 0) | \
            util_bitpack_uint((__unpacked)->malloc_enable, 1, 1) | \
            util_bitpack_uint((__unpacked)->draw_id_register_enable, 2, 2) | \
            util_bitpack_uint((__unpacked)->varying_srt_select, 3, 3) | \
            util_bitpack_uint((__unpacked)->varying_fau_select, 4, 4) | \
            util_bitpack_uint((__unpacked)->varying_tsd_select, 5, 5) | \
            util_bitpack_uint((__unpacked)->fragment_srt_select, 6, 6) | \
            util_bitpack_uint((__unpacked)->fragment_tsd_select, 7, 7) | \
            util_bitpack_uint((__unpacked)->draw_id, 8, 15) | \
            util_bitpack_uint((__unpacked)->opcode, 24, 31); \
   *(__packed) = __tmp_packed; \
} while (0);

#define MALI_CS_RUN_IDVS_unpack(__packed, __unpacked) \
do { \
   MALI_CS_RUN_IDVS_PACKED_T __tmp_packed = *(__packed); \
   if (__tmp_packed.opaque[1] & 0xff0000) fprintf(stderr, "XXX: Invalid field of CS RUN_IDVS unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->flags_override, &__tmp_packed.opaque[0], 0, 31); \
   __gen_unpack_uint((__unpacked)->progress_increment, &__tmp_packed.opaque[0], 32, 32); \
   ...
   __gen_unpack_uint((__unpacked)->varying_srt_select, &__tmp_packed.opaque[0], 35, 35); \
   __gen_unpack_uint((__unpacked)->varying_fau_select, &__tmp_packed.opaque[0], 36, 36); \
   __gen_unpack_uint((__unpacked)->varying_tsd_select, &__tmp_packed.opaque[0], 37, 37); \
   __gen_unpack_uint((__unpacked)->fragment_srt_select, &__tmp_packed.opaque[0], 38, 38); \
   __gen_unpack_uint((__unpacked)->fragment_tsd_select, &__tmp_packed.opaque[0], 39, 39); \
...
#ifndef __OPENCL_VERSION__
static inline void
MALI_CS_RUN_IDVS_print(FILE *fp, const struct MALI_CS_RUN_IDVS * values, unsigned indent)
{
   fprintf(fp, "%*sFlags override: 0x%" PRIx64 "\n", indent, "", values->flags_override);
   fprintf(fp, "%*sProgress increment: %s\n", indent, "", values->progress_increment ? "true" : "false");
   fprintf(fp, "%*sMalloc enable: %s\n", indent, "", values->malloc_enable ? "true" : "false");
   fprintf(fp, "%*sDraw ID register enable: %s\n", indent, "", values->draw_id_register_enable ? "true" : "false");
   fprintf(fp, "%*sVarying SRT select: %s\n", indent, "", values->varying_srt_select ? "true" : "false");
   fprintf(fp, "%*sVarying FAU select: %s\n", indent, "", values->varying_fau_select ? "true" : "false");
   fprintf(fp, "%*sVarying TSD select: %s\n", indent, "", values->varying_tsd_select ? "true" : "false");
   fprintf(fp, "%*sFragment SRT select: %s\n", indent, "", values->fragment_srt_select ? "true" : "false");
   fprintf(fp, "%*sFragment TSD select: %s\n", indent, "", values->fragment_tsd_select ? "true" : "false");
...
#define MALI_CS_RUN_FRAGMENT_header             \
   .tile_order = MALI_TILE_RENDER_ORDER_Z_ORDER,  \
   .progress_increment = false,  \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xff00fe) fprintf(stderr, "XXX: Invalid field of CS RUN_FULLSCREEN unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->flags_override, &__tmp_packed.opaque[0], 0, 31); \
   __gen_unpack_uint((__unpacked)->progress_increment, &__tmp_packed.opaque[0], 32, 32); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS FINISH_FRAGMENT unpacked at word 1\n"); \
...
MALI_CS_FINISH_FRAGMENT_print(FILE *fp, const struct MALI_CS_FINISH_FRAGMENT * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sWait mask: 0x%x\n", indent, "", values->wait_mask);
   fprintf(fp, "%*sLast Heap Chunk: 0x%x\n", indent, "", values->last_heap_chunk);
   fprintf(fp, "%*sFirst Heap Chunk: 0x%x\n", indent, "", values->first_heap_chunk);
...
do { \
   ...
   __tmp_packed.opaque[ 0] = util_bitpack_sint((__unpacked)->offset, 0, 15) | \
            util_bitpack_uint((__unpacked)->condition, 28, 30); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0x8fff0000) fprintf(stderr, "XXX: Invalid field of CS BRANCH unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0xff00ff) fprintf(stderr, "XXX: Invalid field of CS BRANCH unpacked at word 1\n"); \
   __gen_unpack_sint((__unpacked)->offset, &__tmp_packed.opaque[0], 0, 15); \
   __gen_unpack_uint((__unpacked)->condition, &__tmp_packed.opaque[0], 28, 30); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xfffffff0) fprintf(stderr, "XXX: Invalid field of CS REQ_RESOURCE unpacked at word 0\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf000ff) fprintf(stderr, "XXX: Invalid field of CS FLUSH_CACHE2 unpacked at word 1\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS SYNC_ADD32 unpacked at word 1\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS SYNC_SET32 unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->error_propagate, &__tmp_packed.opaque[0], 0, 0); \
   __gen_unpack_uint((__unpacked)->scope, &__tmp_packed.opaque[0], 1, 2); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
   __gen_unpack_uint((__unpacked)->data, &__tmp_packed.opaque[0], 32, 39); \
...
{
   fprintf(fp, "%*sError reject: %s\n", indent, "", values->error_reject ? "true" : "false");
   fprintf(fp, "%*sCondition: %s\n", indent, "", mali_cs_condition_as_str(values->condition));
   fprintf(fp, "%*sData: %u\n", indent, "", values->data);
   fprintf(fp, "%*sAddress: %u\n", indent, "", values->address);
   fprintf(fp, "%*sOpcode: %s\n", indent, "", mali_cs_opcode_as_str(values->opcode));
...
do { \
   ...
   __tmp_packed.opaque[ 0] = util_bitpack_sint((__unpacked)->offset, 0, 15) | \
            util_bitpack_uint((__unpacked)->wait_mask, 16, 31); \
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->state, 0, 1) | \
            util_bitpack_uint((__unpacked)->address, 8, 15) | \
            util_bitpack_uint((__unpacked)->signal_slot, 16, 19) | \
            util_bitpack_uint((__unpacked)->opcode, 24, 31); \
   *(__packed) = __tmp_packed; \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf000fc) fprintf(stderr, "XXX: Invalid field of CS STORE_STATE unpacked at word 1\n"); \
   __gen_unpack_sint((__unpacked)->offset, &__tmp_packed.opaque[0], 0, 15); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
   __gen_unpack_uint((__unpacked)->state, &__tmp_packed.opaque[0], 32, 33); \
   __gen_unpack_uint((__unpacked)->address, &__tmp_packed.opaque[0], 40, 47); \
   __gen_unpack_uint((__unpacked)->signal_slot, &__tmp_packed.opaque[0], 48, 51); \
   __gen_unpack_uint((__unpacked)->opcode, &__tmp_packed.opaque[0], 56, 63); \
} while (0);
...
do { \
   ...
   assert(((__unpacked)->size & 0x7) == 0); \
   __tmp_packed.opaque[ 0] = util_bitpack_uint((__unpacked)->size >> 3, 0, 15); \
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->opcode, 24, 31); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   (__unpacked)->size = (__unpacked)->size << 3; \
   __gen_unpack_uint((__unpacked)->opcode, &__tmp_packed.opaque[0], 56, 63); \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xffff0000) fprintf(stderr, "XXX: Invalid field of CS RUN_COMPUTE_INDIRECT unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0xff00fe) fprintf(stderr, "XXX: Invalid field of CS RUN_COMPUTE_INDIRECT unpacked at word 1\n"); \
...
do { \
   ...
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->operation, 0, 1) | \
            util_bitpack_uint((__unpacked)->signal_slot, 16, 19) | \
            util_bitpack_uint((__unpacked)->opcode, 24, 31); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf0fffc) fprintf(stderr, "XXX: Invalid field of CS HEAP_OPERATION unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
   __gen_unpack_uint((__unpacked)->operation, &__tmp_packed.opaque[0], 32, 33); \
   __gen_unpack_uint((__unpacked)->signal_slot, &__tmp_packed.opaque[0], 48, 51); \
   __gen_unpack_uint((__unpacked)->opcode, &__tmp_packed.opaque[0], 56, 63); \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS TRACE_POINT unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS SYNC_ADD64 unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->error_propagate, &__tmp_packed.opaque[0], 0, 0); \
   __gen_unpack_uint((__unpacked)->scope, &__tmp_packed.opaque[0], 1, 2); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
   __gen_unpack_uint((__unpacked)->data, &__tmp_packed.opaque[0], 32, 39); \
...
do { \
   ...
   if (__tmp_packed.opaque[1] & 0xf00000) fprintf(stderr, "XXX: Invalid field of CS SYNC_SET64 unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->error_propagate, &__tmp_packed.opaque[0], 0, 0); \
   __gen_unpack_uint((__unpacked)->scope, &__tmp_packed.opaque[0], 1, 2); \
   __gen_unpack_uint((__unpacked)->wait_mask, &__tmp_packed.opaque[0], 16, 31); \
   __gen_unpack_uint((__unpacked)->data, &__tmp_packed.opaque[0], 32, 39); \
...
enum mali_idvs_sr {
        MALI_IDVS_SR_SRT_0                   =      0,
        MALI_IDVS_SR_SRT_1                   =      2,
        MALI_IDVS_SR_SRT_2                   =      4,
        MALI_IDVS_SR_SRT_3                   =      6,
        MALI_IDVS_SR_FAU_0                   =      8,
        MALI_IDVS_SR_FAU_1                   =     10,
        MALI_IDVS_SR_FAU_2                   =     12,
        MALI_IDVS_SR_FAU_3                   =     14,
        MALI_IDVS_SR_SPD_0                   =     16,
        MALI_IDVS_SR_SPD_1                   =     18,
        MALI_IDVS_SR_SPD_2                   =     20,
        MALI_IDVS_SR_SPD_3                   =     22,
        MALI_IDVS_SR_TSD_0                   =     24,
        MALI_IDVS_SR_TSD_1                   =     26,
        MALI_IDVS_SR_TSD_2                   =     28,
        MALI_IDVS_SR_TSD_3                   =     30,
        ...
        MALI_IDVS_SR_DCD2                    =     38,
        MALI_IDVS_SR_INDEX_BUFFER_SIZE       =     39,
        MALI_IDVS_SR_TILER_CTX               =     40,
        MALI_IDVS_SR_SCISSOR_BOX             =     42,
        MALI_IDVS_SR_LOW_DEPTH_CLAMP         =     44,
        MALI_IDVS_SR_HIGH_DEPTH_CLAMP        =     45,
        MALI_IDVS_SR_OQ                      =     46,
        MALI_IDVS_SR_VARY_SIZE               =     48,
        MALI_IDVS_SR_BLEND_DESC              =     50,
        MALI_IDVS_SR_ZSD                     =     52,
        MALI_IDVS_SR_INDEX_BUFFER            =     54,
...
{
    switch (imm) {
    case MALI_IDVS_SR_SRT_0: return "SRT_0";
    case MALI_IDVS_SR_SRT_1: return "SRT_1";
    case MALI_IDVS_SR_SRT_2: return "SRT_2";
    case MALI_IDVS_SR_SRT_3: return "SRT_3";
    case MALI_IDVS_SR_FAU_0: return "FAU_0";
    case MALI_IDVS_SR_FAU_1: return "FAU_1";
    case MALI_IDVS_SR_FAU_2: return "FAU_2";
    case MALI_IDVS_SR_FAU_3: return "FAU_3";
    case MALI_IDVS_SR_SPD_0: return "SPD_0";
    case MALI_IDVS_SR_SPD_1: return "SPD_1";
    case MALI_IDVS_SR_SPD_2: return "SPD_2";
    case MALI_IDVS_SR_SPD_3: return "SPD_3";
    case MALI_IDVS_SR_TSD_0: return "TSD_0";
    case MALI_IDVS_SR_TSD_1: return "TSD_1";
    case MALI_IDVS_SR_TSD_2: return "TSD_2";
    case MALI_IDVS_SR_TSD_3: return "TSD_3";
    ...
    case MALI_IDVS_SR_LOW_DEPTH_CLAMP: return "LOW_DEPTH_CLAMP";
    case MALI_IDVS_SR_HIGH_DEPTH_CLAMP: return "HIGH_DEPTH_CLAMP";
...
enum mali_afbc_compression_mode {
        ...
        MALI_AFBC_COMPRESSION_MODE_R10G10B10A10 =     23,
...
mali_afbc_compression_mode_as_str(enum mali_afbc_compression_mode imm)
{
    ...
    case MALI_AFBC_COMPRESSION_MODE_R10G10B10A10: return "R10G10B10A10";
...
do { \
   ...
   __tmp_packed.opaque[10] = util_bitpack_uint((__unpacked)->rgb.writeback_buffer.row_stride, 0, 31) | \
            ...
            util_bitpack_uint((__unpacked)->afrc_rgb.writeback_buffer.row_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->afrc_yuv.plane_0_stride, 0, 31); \
   __tmp_packed.opaque[11] = util_bitpack_uint((__unpacked)->rgb.writeback_buffer.surface_stride, 0, 31) | \
            ...
            util_bitpack_uint((__unpacked)->afrc_yuv.plane_1_2_stride, 0, 31); \
...
do { \
   ...
   __gen_unpack_uint((__unpacked)->afrc_rgb.writeback_buffer.row_stride, &__tmp_packed.opaque[0], 320, 351); \
   ...
   __gen_unpack_uint((__unpacked)->afrc_yuv.plane_0_stride, &__tmp_packed.opaque[0], 320, 351); \
   __gen_unpack_uint((__unpacked)->afrc_yuv.plane_1_2_stride, &__tmp_packed.opaque[0], 352, 383); \
...
do { \
   ...
   if (__tmp_packed.opaque[2] & 0xfff90000) fprintf(stderr, "XXX: Invalid field of Tiler Context unpacked at word 2\n"); \
...
do { \
   ...
   __tmp_packed.opaque[ 3] = 0; \
   __tmp_packed.opaque[ 4] = util_bitpack_uint((__unpacked)->shader_read_only_z_s, 21, 21) | \
            util_bitpack_uint((__unpacked)->depth_cull_enable, 22, 22) | \
...
do { \
   ...
   if (__tmp_packed.opaque[4] & 0x1fffff) fprintf(stderr, "XXX: Invalid field of Depth/stencil unpacked at word 4\n"); \
   __gen_unpack_uint((__unpacked)->type, &__tmp_packed.opaque[0], 0, 3); \
   ...
   __gen_unpack_uint((__unpacked)->shader_read_only_z_s, &__tmp_packed.opaque[0], 149, 149); \
...
MALI_DEPTH_STENCIL_print(FILE *fp, const struct MALI_DEPTH_STENCIL * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sShader read only Z/S: %s\n", indent, "", values->shader_read_only_z_s ? "true" : "false");
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xff000000) fprintf(stderr, "XXX: Invalid field of DCD Flags 2 unpacked at word 0\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[5] & 0xff000000) fprintf(stderr, "XXX: Invalid field of Draw unpacked at word 5\n"); \
