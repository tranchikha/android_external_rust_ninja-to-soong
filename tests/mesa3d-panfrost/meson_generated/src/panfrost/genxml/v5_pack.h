...
do { \
   ...
   __tmp_packed.opaque[ 0] = util_bitpack_uint((__unpacked)->load_destination, 0, 0) | \
            util_bitpack_uint((__unpacked)->blend_shader, 1, 1) | \
            util_bitpack_uint((__unpacked)->blend_shader_contains_discard, 2, 2) | \
   ...
   __tmp_packed.opaque[ 2] = util_bitpack_uint((__unpacked)->shader_pc, 0, 63) | \
            util_bitpack_uint((__unpacked)->equation.rgb.a, 0, 1) | \
   ...
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->shader_pc, 0, 63) >> 32 | \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xfffff0f8) fprintf(stderr, "XXX: Invalid field of Blend unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0xffffffff) fprintf(stderr, "XXX: Invalid field of Blend unpacked at word 1\n"); \
   __gen_unpack_uint((__unpacked)->load_destination, &__tmp_packed.opaque[0], 0, 0); \
   __gen_unpack_uint((__unpacked)->blend_shader, &__tmp_packed.opaque[0], 1, 1); \
   __gen_unpack_uint((__unpacked)->blend_shader_contains_discard, &__tmp_packed.opaque[0], 2, 2); \
   ...
   __gen_unpack_uint((__unpacked)->shader_pc, &__tmp_packed.opaque[0], 64, 127); \
   __gen_unpack_uint((__unpacked)->equation.rgb.a, &__tmp_packed.opaque[0], 64, 65); \
   __gen_unpack_uint((__unpacked)->equation.rgb.negate_a, &__tmp_packed.opaque[0], 67, 67); \
   __gen_unpack_uint((__unpacked)->equation.rgb.b, &__tmp_packed.opaque[0], 68, 69); \
   __gen_unpack_uint((__unpacked)->equation.rgb.negate_b, &__tmp_packed.opaque[0], 71, 71); \
   __gen_unpack_uint((__unpacked)->equation.rgb.c, &__tmp_packed.opaque[0], 72, 74); \
   __gen_unpack_uint((__unpacked)->equation.rgb.invert_c, &__tmp_packed.opaque[0], 75, 75); \
   __gen_unpack_uint((__unpacked)->equation.alpha.a, &__tmp_packed.opaque[0], 76, 77); \
   __gen_unpack_uint((__unpacked)->equation.alpha.negate_a, &__tmp_packed.opaque[0], 79, 79); \
   __gen_unpack_uint((__unpacked)->equation.alpha.b, &__tmp_packed.opaque[0], 80, 81); \
   __gen_unpack_uint((__unpacked)->equation.alpha.negate_b, &__tmp_packed.opaque[0], 83, 83); \
   __gen_unpack_uint((__unpacked)->equation.alpha.c, &__tmp_packed.opaque[0], 84, 86); \
   __gen_unpack_uint((__unpacked)->equation.alpha.invert_c, &__tmp_packed.opaque[0], 87, 87); \
   __gen_unpack_uint((__unpacked)->equation.color_mask, &__tmp_packed.opaque[0], 92, 95); \
   __gen_unpack_float((__unpacked)->blend_constant, &__tmp_packed.opaque[0], 96, 127); \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xf000) fprintf(stderr, "XXX: Invalid field of Draw unpacked at word 0\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xe00000) fprintf(stderr, "XXX: Invalid field of Multisample, Misc unpacked at word 0\n"); \
...
do { \
   ...
   __tmp_packed.opaque[14] = util_bitpack_uint((__unpacked)->legacy_blend_shader, 0, 63); \
   __tmp_packed.opaque[15] = util_bitpack_uint((__unpacked)->legacy_blend_shader, 0, 63) >> 32; \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[8] & 0xe00000) fprintf(stderr, "XXX: Invalid field of Renderer State unpacked at word 8\n"); \
   ...
   __gen_unpack_uint((__unpacked)->legacy_blend_shader, &__tmp_packed.opaque[0], 448, 511); \
} while (0);
...
do { \
   ...
   __tmp_packed.opaque[ 0] = util_bitpack_uint((__unpacked)->width - 1, 0, 15) | \
            util_bitpack_uint((__unpacked)->height - 1, 16, 31); \
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->bound_min_x, 0, 15) | \
            util_bitpack_uint((__unpacked)->bound_min_y, 16, 31); \
   __tmp_packed.opaque[ 2] = util_bitpack_uint((__unpacked)->bound_max_x, 0, 15) | \
            util_bitpack_uint((__unpacked)->bound_max_y, 16, 31); \
   __tmp_packed.opaque[ 3] = util_bitpack_uint(util_logbase2((__unpacked)->sample_count), 0, 2) | \
   ...
   __tmp_packed.opaque[ 4] = util_bitpack_uint((__unpacked)->s_clear, 0, 7) | \
   ...
   __tmp_packed.opaque[ 5] = util_bitpack_float((__unpacked)->z_clear); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0x800000) fprintf(stderr, "XXX: Invalid field of Framebuffer Parameters unpacked at word 3\n"); \
   if (__tmp_packed.opaque[4] & 0x3fc0f800) fprintf(stderr, "XXX: Invalid field of Framebuffer Parameters unpacked at word 4\n"); \
   __gen_unpack_uint((__unpacked)->width, &__tmp_packed.opaque[0], 0, 15); \
   (__unpacked)->width = (__unpacked)->width + 1; \
   __gen_unpack_uint((__unpacked)->height, &__tmp_packed.opaque[0], 16, 31); \
   (__unpacked)->height = (__unpacked)->height + 1; \
   __gen_unpack_uint((__unpacked)->bound_min_x, &__tmp_packed.opaque[0], 32, 47); \
   __gen_unpack_uint((__unpacked)->bound_min_y, &__tmp_packed.opaque[0], 48, 63); \
   __gen_unpack_uint((__unpacked)->bound_max_x, &__tmp_packed.opaque[0], 64, 79); \
   __gen_unpack_uint((__unpacked)->bound_max_y, &__tmp_packed.opaque[0], 80, 95); \
   __gen_unpack_uint((__unpacked)->sample_count, &__tmp_packed.opaque[0], 96, 98); \
   (__unpacked)->sample_count = 1U << (__unpacked)->sample_count; \
   __gen_unpack_uint((__unpacked)->sample_pattern, &__tmp_packed.opaque[0], 99, 101); \
   __gen_unpack_uint((__unpacked)->tie_break_rule, &__tmp_packed.opaque[0], 102, 104); \
   __gen_unpack_uint((__unpacked)->effective_tile_size, &__tmp_packed.opaque[0], 105, 108); \
   (__unpacked)->effective_tile_size = 1U << (__unpacked)->effective_tile_size; \
   __gen_unpack_uint((__unpacked)->x_downsampling_scale, &__tmp_packed.opaque[0], 109, 111); \
   __gen_unpack_uint((__unpacked)->y_downsampling_scale, &__tmp_packed.opaque[0], 112, 114); \
   __gen_unpack_uint((__unpacked)->render_target_count, &__tmp_packed.opaque[0], 115, 118); \
   (__unpacked)->render_target_count = (__unpacked)->render_target_count + 1; \
   __gen_unpack_uint((__unpacked)->color_buffer_allocation, &__tmp_packed.opaque[0], 120, 127); \
   (__unpacked)->color_buffer_allocation = (__unpacked)->color_buffer_allocation << 10; \
   __gen_unpack_uint((__unpacked)->s_clear, &__tmp_packed.opaque[0], 128, 135); \
   __gen_unpack_uint((__unpacked)->s_write_enable, &__tmp_packed.opaque[0], 136, 136); \
   __gen_unpack_uint((__unpacked)->s_preload_enable, &__tmp_packed.opaque[0], 137, 137); \
   __gen_unpack_uint((__unpacked)->s_unload_enable, &__tmp_packed.opaque[0], 138, 138); \
   __gen_unpack_uint((__unpacked)->z_internal_format, &__tmp_packed.opaque[0], 144, 145); \
   __gen_unpack_uint((__unpacked)->z_write_enable, &__tmp_packed.opaque[0], 146, 146); \
   __gen_unpack_uint((__unpacked)->z_preload_enable, &__tmp_packed.opaque[0], 147, 147); \
   __gen_unpack_uint((__unpacked)->z_unload_enable, &__tmp_packed.opaque[0], 148, 148); \
   __gen_unpack_uint((__unpacked)->has_zs_crc_extension, &__tmp_packed.opaque[0], 149, 149); \
   __gen_unpack_uint((__unpacked)->crc_read_enable, &__tmp_packed.opaque[0], 158, 158); \
   __gen_unpack_uint((__unpacked)->crc_write_enable, &__tmp_packed.opaque[0], 159, 159); \
   __gen_unpack_float((__unpacked)->z_clear, &__tmp_packed.opaque[0], 160, 191); \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xffffffff) fprintf(stderr, "XXX: Invalid field of CRC unpacked at word 3\n"); \
...
struct MALI_ZS_TARGET {
   ...
   enum mali_zs_preload_format          preload_format;
   uint64_t                             base;
   uint64_t                             row_stride;
   uint64_t                             surface_stride;
};
...
do { \
   ...
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->write_format, 0, 3) | \
            util_bitpack_uint((__unpacked)->block_format, 4, 5) | \
            util_bitpack_uint((__unpacked)->msaa, 6, 7) | \
            util_bitpack_uint((__unpacked)->big_endian, 8, 8) | \
            util_bitpack_uint((__unpacked)->clean_pixel_write_enable, 10, 10) | \
            util_bitpack_uint((__unpacked)->preload_format, 28, 31); \
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xffffa00) fprintf(stderr, "XXX: Invalid field of ZS Target unpacked at word 3\n"); \
   ...
   __gen_unpack_uint((__unpacked)->block_format, &__tmp_packed.opaque[0], 100, 101); \
   __gen_unpack_uint((__unpacked)->msaa, &__tmp_packed.opaque[0], 102, 103); \
   __gen_unpack_uint((__unpacked)->big_endian, &__tmp_packed.opaque[0], 104, 104); \
   __gen_unpack_uint((__unpacked)->clean_pixel_write_enable, &__tmp_packed.opaque[0], 106, 106); \
   __gen_unpack_uint((__unpacked)->preload_format, &__tmp_packed.opaque[0], 124, 127); \
...
MALI_ZS_TARGET_print(FILE *fp, const struct MALI_ZS_TARGET * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sPreload Format: %s\n", indent, "", mali_zs_preload_format_as_str(values->preload_format));
   fprintf(fp, "%*sBase: 0x%" PRIx64 "\n", indent, "", values->base);
   fprintf(fp, "%*sRow Stride: 0x%" PRIx64 "\n", indent, "", values->row_stride);
   fprintf(fp, "%*sSurface Stride: 0x%" PRIx64 "\n", indent, "", values->surface_stride);
}
...
do { \
   ...
   __tmp_packed.opaque[ 7] = util_bitpack_uint((__unpacked)->chunk_size, 0, 11) | \
            util_bitpack_uint((__unpacked)->sparse, 16, 16); \
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xfffffb00) fprintf(stderr, "XXX: Invalid field of AFBC ZS Target unpacked at word 3\n"); \
   if (__tmp_packed.opaque[6] & 0xffffffff) fprintf(stderr, "XXX: Invalid field of AFBC ZS Target unpacked at word 6\n"); \
   if (__tmp_packed.opaque[7] & 0xfffef000) fprintf(stderr, "XXX: Invalid field of AFBC ZS Target unpacked at word 7\n"); \
   ...
   __gen_unpack_uint((__unpacked)->sparse, &__tmp_packed.opaque[0], 240, 240); \
...
do { \
   ...
   __tmp_packed.opaque[ 1] = 0; \
   __tmp_packed.opaque[ 2] = 0; \
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->clean_pixel_write_enable, 10, 10) | \
            util_bitpack_uint((__unpacked)->write_format, 16, 19) | \
            util_bitpack_uint((__unpacked)->block_format, 20, 21) | \
            util_bitpack_uint((__unpacked)->msaa, 22, 23); \
   __tmp_packed.opaque[ 4] = 0; \
   __tmp_packed.opaque[ 5] = 0; \
   __tmp_packed.opaque[ 6] = 0; \
   __tmp_packed.opaque[ 7] = 0; \
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xff00fbff) fprintf(stderr, "XXX: Invalid field of S Target unpacked at word 3\n"); \
   ...
   __gen_unpack_uint((__unpacked)->block_format, &__tmp_packed.opaque[0], 116, 117); \
   __gen_unpack_uint((__unpacked)->msaa, &__tmp_packed.opaque[0], 118, 119); \
...
do { \
   ...
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->zs.write_format, 0, 3) | \
            util_bitpack_uint((__unpacked)->zs.block_format, 4, 5) | \
            util_bitpack_uint((__unpacked)->zs.msaa, 6, 7) | \
            util_bitpack_uint((__unpacked)->zs.big_endian, 8, 8) | \
            util_bitpack_uint((__unpacked)->zs.clean_pixel_write_enable, 10, 10) | \
            util_bitpack_uint((__unpacked)->zs.preload_format, 28, 31) | \
            util_bitpack_uint((__unpacked)->afbc_zs.write_format, 0, 3) | \
            util_bitpack_uint((__unpacked)->afbc_zs.block_format, 4, 5) | \
            util_bitpack_uint((__unpacked)->afbc_zs.msaa, 6, 7) | \
            util_bitpack_uint((__unpacked)->afbc_zs.clean_pixel_write_enable, 10, 10) | \
            util_bitpack_uint((__unpacked)->s.clean_pixel_write_enable, 10, 10) | \
            util_bitpack_uint((__unpacked)->s.write_format, 16, 19) | \
            util_bitpack_uint((__unpacked)->s.block_format, 20, 21) | \
            util_bitpack_uint((__unpacked)->s.msaa, 22, 23); \
   ...
   __tmp_packed.opaque[ 7] = util_bitpack_uint((__unpacked)->zs.surface_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->afbc_zs.chunk_size, 0, 11) | \
            util_bitpack_uint((__unpacked)->afbc_zs.sparse, 16, 16); \
   ...
   __tmp_packed.opaque[10] = util_bitpack_uint((__unpacked)->afbc_zs.body_size, 0, 31) | \
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xf00fa00) fprintf(stderr, "XXX: Invalid field of ZS CRC Extension unpacked at word 3\n"); \
   if (__tmp_packed.opaque[12] & 0xffffffff) fprintf(stderr, "XXX: Invalid field of ZS CRC Extension unpacked at word 12\n"); \
   if (__tmp_packed.opaque[13] & 0xffffffff) fprintf(stderr, "XXX: Invalid field of ZS CRC Extension unpacked at word 13\n"); \
   ...
   __gen_unpack_uint((__unpacked)->zs.block_format, &__tmp_packed.opaque[0], 100, 101); \
   __gen_unpack_uint((__unpacked)->zs.msaa, &__tmp_packed.opaque[0], 102, 103); \
   __gen_unpack_uint((__unpacked)->zs.big_endian, &__tmp_packed.opaque[0], 104, 104); \
   __gen_unpack_uint((__unpacked)->zs.clean_pixel_write_enable, &__tmp_packed.opaque[0], 106, 106); \
   __gen_unpack_uint((__unpacked)->zs.preload_format, &__tmp_packed.opaque[0], 124, 127); \
   ...
   __gen_unpack_uint((__unpacked)->afbc_zs.block_format, &__tmp_packed.opaque[0], 100, 101); \
   __gen_unpack_uint((__unpacked)->afbc_zs.msaa, &__tmp_packed.opaque[0], 102, 103); \
   __gen_unpack_uint((__unpacked)->afbc_zs.clean_pixel_write_enable, &__tmp_packed.opaque[0], 106, 106); \
   __gen_unpack_uint((__unpacked)->afbc_zs.header, &__tmp_packed.opaque[0], 128, 191); \
   __gen_unpack_uint((__unpacked)->afbc_zs.chunk_size, &__tmp_packed.opaque[0], 224, 235); \
   __gen_unpack_uint((__unpacked)->afbc_zs.sparse, &__tmp_packed.opaque[0], 240, 240); \
   __gen_unpack_uint((__unpacked)->afbc_zs.body, &__tmp_packed.opaque[0], 256, 319); \
   __gen_unpack_uint((__unpacked)->afbc_zs.body_size, &__tmp_packed.opaque[0], 320, 351); \
   __gen_unpack_uint((__unpacked)->s.clean_pixel_write_enable, &__tmp_packed.opaque[0], 106, 106); \
   __gen_unpack_uint((__unpacked)->s.write_format, &__tmp_packed.opaque[0], 112, 115); \
   __gen_unpack_uint((__unpacked)->s.block_format, &__tmp_packed.opaque[0], 116, 117); \
   __gen_unpack_uint((__unpacked)->s.msaa, &__tmp_packed.opaque[0], 118, 119); \
...
do { \
   ...
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->write_enable, 0, 0) | \
            ...
            util_bitpack_uint((__unpacked)->writeback_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->writeback_block_format, 10, 11) | \
            ...
            util_bitpack_uint((__unpacked)->writeback_sampling_mode, 29, 30) | \
            util_bitpack_uint((__unpacked)->clean_pixel_write_enable, 31, 31); \
   __tmp_packed.opaque[ 2] = util_bitpack_uint((__unpacked)->preload_enable, 0, 0) | \
            util_bitpack_uint((__unpacked)->unload_enable, 1, 1) | \
            util_bitpack_uint((__unpacked)->preload_format, 3, 7) | \
            util_bitpack_uint((__unpacked)->preload_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->preload_block_format, 10, 11) | \
            util_bitpack_uint((__unpacked)->preload_msaa, 12, 13); \
   __tmp_packed.opaque[ 3] = 0; \
   __tmp_packed.opaque[ 4] = 0; \
   __tmp_packed.opaque[ 5] = 0; \
   __tmp_packed.opaque[ 6] = 0; \
   ...
   __tmp_packed.opaque[12] = util_bitpack_uint((__unpacked)->preload_buffer.base, 0, 63) | \
            util_bitpack_uint((__unpacked)->clear.color_0, 0, 31); \
   __tmp_packed.opaque[13] = util_bitpack_uint((__unpacked)->preload_buffer.base, 0, 63) >> 32 | \
            util_bitpack_uint((__unpacked)->clear.color_1, 0, 31); \
   __tmp_packed.opaque[14] = util_bitpack_uint((__unpacked)->preload_buffer.row_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->clear.color_2, 0, 31); \
   __tmp_packed.opaque[15] = util_bitpack_uint((__unpacked)->preload_buffer.surface_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->clear.color_3, 0, 31); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0x2ff000f) fprintf(stderr, "XXX: Invalid field of RGB Render Target unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0x10000006) fprintf(stderr, "XXX: Invalid field of RGB Render Target unpacked at word 1\n"); \
   if (__tmp_packed.opaque[2] & 0xffffc004) fprintf(stderr, "XXX: Invalid field of RGB Render Target unpacked at word 2\n"); \
   ...
   __gen_unpack_uint((__unpacked)->writeback_endianness, &__tmp_packed.opaque[0], 40, 41); \
   __gen_unpack_uint((__unpacked)->writeback_block_format, &__tmp_packed.opaque[0], 42, 43); \
   ...
   __gen_unpack_uint((__unpacked)->writeback_sampling_mode, &__tmp_packed.opaque[0], 61, 62); \
   __gen_unpack_uint((__unpacked)->clean_pixel_write_enable, &__tmp_packed.opaque[0], 63, 63); \
   __gen_unpack_uint((__unpacked)->preload_enable, &__tmp_packed.opaque[0], 64, 64); \
   __gen_unpack_uint((__unpacked)->unload_enable, &__tmp_packed.opaque[0], 65, 65); \
   __gen_unpack_uint((__unpacked)->preload_format, &__tmp_packed.opaque[0], 67, 71); \
   __gen_unpack_uint((__unpacked)->preload_endianness, &__tmp_packed.opaque[0], 72, 73); \
   __gen_unpack_uint((__unpacked)->preload_block_format, &__tmp_packed.opaque[0], 74, 75); \
   __gen_unpack_uint((__unpacked)->preload_msaa, &__tmp_packed.opaque[0], 76, 77); \
   ...
   __gen_unpack_uint((__unpacked)->preload_buffer.base, &__tmp_packed.opaque[0], 384, 447); \
   __gen_unpack_uint((__unpacked)->preload_buffer.row_stride, &__tmp_packed.opaque[0], 448, 479); \
   __gen_unpack_uint((__unpacked)->preload_buffer.surface_stride, &__tmp_packed.opaque[0], 480, 511); \
...
#define MALI_YUV_RENDER_TARGET_LENGTH 48
#define MALI_YUV_RENDER_TARGET_ALIGN 64
struct mali_yuv_render_target_packed { uint32_t opaque[12]; };
...
do { \
   ...
   __tmp_packed.opaque[ 2] = util_bitpack_uint((__unpacked)->preload_enable, 0, 0) | \
            ...
            util_bitpack_uint((__unpacked)->preload_block_format, 10, 11) | \
            util_bitpack_uint((__unpacked)->preload_msaa, 12, 13) | \
            util_bitpack_uint((__unpacked)->conv_k5, 16, 23) | \
            util_bitpack_uint((__unpacked)->conv_k6, 24, 24) | \
            util_bitpack_uint((__unpacked)->conv_k7_clamp, 25, 26) | \
            util_bitpack_uint((__unpacked)->conv_k8, 27, 27) | \
            util_bitpack_uint((__unpacked)->conv_disable, 31, 31); \
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->conv_k1, 0, 7) | \
            util_bitpack_uint((__unpacked)->conv_k2, 8, 15) | \
            util_bitpack_uint((__unpacked)->conv_k3, 16, 23) | \
            util_bitpack_uint((__unpacked)->conv_k4, 24, 31); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0x2ff000f) fprintf(stderr, "XXX: Invalid field of YUV Render Target unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0x10000006) fprintf(stderr, "XXX: Invalid field of YUV Render Target unpacked at word 1\n"); \
   if (__tmp_packed.opaque[2] & 0x7000c004) fprintf(stderr, "XXX: Invalid field of YUV Render Target unpacked at word 2\n"); \
   __gen_unpack_uint((__unpacked)->internal_buffer_offset, &__tmp_packed.opaque[0], 4, 15); \
   (__unpacked)->internal_buffer_offset = (__unpacked)->internal_buffer_offset << 4; \
   __gen_unpack_uint((__unpacked)->yuv_enable, &__tmp_packed.opaque[0], 24, 24); \
   __gen_unpack_uint((__unpacked)->internal_format, &__tmp_packed.opaque[0], 26, 31); \
   ...
   __gen_unpack_uint((__unpacked)->preload_block_format, &__tmp_packed.opaque[0], 74, 75); \
   __gen_unpack_uint((__unpacked)->preload_msaa, &__tmp_packed.opaque[0], 76, 77); \
   __gen_unpack_uint((__unpacked)->conv_k5, &__tmp_packed.opaque[0], 80, 87); \
   __gen_unpack_uint((__unpacked)->conv_k6, &__tmp_packed.opaque[0], 88, 88); \
   __gen_unpack_uint((__unpacked)->conv_k7_clamp, &__tmp_packed.opaque[0], 89, 90); \
   __gen_unpack_uint((__unpacked)->conv_k8, &__tmp_packed.opaque[0], 91, 91); \
   __gen_unpack_uint((__unpacked)->conv_disable, &__tmp_packed.opaque[0], 95, 95); \
   __gen_unpack_uint((__unpacked)->conv_k1, &__tmp_packed.opaque[0], 96, 103); \
   __gen_unpack_uint((__unpacked)->conv_k2, &__tmp_packed.opaque[0], 104, 111); \
   __gen_unpack_uint((__unpacked)->conv_k3, &__tmp_packed.opaque[0], 112, 119); \
   __gen_unpack_uint((__unpacked)->conv_k4, &__tmp_packed.opaque[0], 120, 127); \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0x2ff000f) fprintf(stderr, "XXX: Invalid field of AFBC RGB Render Target unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0x10000006) fprintf(stderr, "XXX: Invalid field of AFBC RGB Render Target unpacked at word 1\n"); \
   ...
   if (__tmp_packed.opaque[7] & 0xfffcf000) fprintf(stderr, "XXX: Invalid field of AFBC RGB Render Target unpacked at word 7\n"); \
...
do { \
   ...
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->rgb.write_enable, 0, 0) | \
            ...
            util_bitpack_uint((__unpacked)->rgb.writeback_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->rgb.writeback_block_format, 10, 11) | \
            ...
            util_bitpack_uint((__unpacked)->rgb.writeback_sampling_mode, 29, 30) | \
            ...
            util_bitpack_uint((__unpacked)->yuv.writeback_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->yuv.writeback_block_format, 10, 11) | \
            ...
            util_bitpack_uint((__unpacked)->yuv.writeback_sampling_mode, 29, 30) | \
            ...
            util_bitpack_uint((__unpacked)->afbc_rgb.writeback_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->afbc_rgb.writeback_block_format, 10, 11) | \
            ...
            util_bitpack_uint((__unpacked)->afbc_rgb.writeback_sampling_mode, 29, 30) | \
            util_bitpack_uint((__unpacked)->afbc_rgb.clean_pixel_write_enable, 31, 31); \
   __tmp_packed.opaque[ 2] = util_bitpack_uint((__unpacked)->rgb.preload_enable, 0, 0) | \
            util_bitpack_uint((__unpacked)->rgb.unload_enable, 1, 1) | \
            util_bitpack_uint((__unpacked)->rgb.preload_format, 3, 7) | \
            util_bitpack_uint((__unpacked)->rgb.preload_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->rgb.preload_block_format, 10, 11) | \
            util_bitpack_uint((__unpacked)->rgb.preload_msaa, 12, 13) | \
            util_bitpack_uint((__unpacked)->yuv.preload_enable, 0, 0) | \
            util_bitpack_uint((__unpacked)->yuv.unload_enable, 1, 1) | \
            util_bitpack_uint((__unpacked)->yuv.preload_format, 3, 7) | \
            util_bitpack_uint((__unpacked)->yuv.preload_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->yuv.preload_block_format, 10, 11) | \
            util_bitpack_uint((__unpacked)->yuv.preload_msaa, 12, 13) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k5, 16, 23) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k6, 24, 24) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k7_clamp, 25, 26) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k8, 27, 27) | \
            util_bitpack_uint((__unpacked)->yuv.conv_disable, 31, 31); \
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->yuv.conv_k1, 0, 7) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k2, 8, 15) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k3, 16, 23) | \
            util_bitpack_uint((__unpacked)->yuv.conv_k4, 24, 31); \
   ...
   __tmp_packed.opaque[ 7] = util_bitpack_uint((__unpacked)->yuv.plane_1_base, 0, 63) >> 32 | \
            ...
            util_bitpack_uint((__unpacked)->afbc_rgb.sparse, 16, 16) | \
   ...
   __tmp_packed.opaque[12] = util_bitpack_uint((__unpacked)->rgb.preload_buffer.base, 0, 63) | \
            util_bitpack_uint((__unpacked)->rgb.clear.color_0, 0, 31) | \
            util_bitpack_uint((__unpacked)->afbc_rgb.clear.color_0, 0, 31); \
   __tmp_packed.opaque[13] = util_bitpack_uint((__unpacked)->rgb.preload_buffer.base, 0, 63) >> 32 | \
            util_bitpack_uint((__unpacked)->rgb.clear.color_1, 0, 31) | \
            util_bitpack_uint((__unpacked)->afbc_rgb.clear.color_1, 0, 31); \
   __tmp_packed.opaque[14] = util_bitpack_uint((__unpacked)->rgb.preload_buffer.row_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->rgb.clear.color_2, 0, 31) | \
            util_bitpack_uint((__unpacked)->afbc_rgb.clear.color_2, 0, 31); \
   __tmp_packed.opaque[15] = util_bitpack_uint((__unpacked)->rgb.preload_buffer.surface_stride, 0, 31) | \
            util_bitpack_uint((__unpacked)->rgb.clear.color_3, 0, 31) | \
...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0x2ff000f) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 0\n"); \
   if (__tmp_packed.opaque[1] & 0x10000006) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 1\n"); \
   if (__tmp_packed.opaque[2] & 0x7000c004) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 2\n"); \
   ...
   __gen_unpack_uint((__unpacked)->rgb.writeback_endianness, &__tmp_packed.opaque[0], 40, 41); \
   __gen_unpack_uint((__unpacked)->rgb.writeback_block_format, &__tmp_packed.opaque[0], 42, 43); \
   ...
   __gen_unpack_uint((__unpacked)->rgb.writeback_sampling_mode, &__tmp_packed.opaque[0], 61, 62); \
   __gen_unpack_uint((__unpacked)->rgb.clean_pixel_write_enable, &__tmp_packed.opaque[0], 63, 63); \
   __gen_unpack_uint((__unpacked)->rgb.preload_enable, &__tmp_packed.opaque[0], 64, 64); \
   __gen_unpack_uint((__unpacked)->rgb.unload_enable, &__tmp_packed.opaque[0], 65, 65); \
   __gen_unpack_uint((__unpacked)->rgb.preload_format, &__tmp_packed.opaque[0], 67, 71); \
   __gen_unpack_uint((__unpacked)->rgb.preload_endianness, &__tmp_packed.opaque[0], 72, 73); \
   __gen_unpack_uint((__unpacked)->rgb.preload_block_format, &__tmp_packed.opaque[0], 74, 75); \
   __gen_unpack_uint((__unpacked)->rgb.preload_msaa, &__tmp_packed.opaque[0], 76, 77); \
   ...
   __gen_unpack_uint((__unpacked)->rgb.preload_buffer.base, &__tmp_packed.opaque[0], 384, 447); \
   __gen_unpack_uint((__unpacked)->rgb.preload_buffer.row_stride, &__tmp_packed.opaque[0], 448, 479); \
   __gen_unpack_uint((__unpacked)->rgb.preload_buffer.surface_stride, &__tmp_packed.opaque[0], 480, 511); \
   ...
   __gen_unpack_uint((__unpacked)->yuv.writeback_endianness, &__tmp_packed.opaque[0], 40, 41); \
   __gen_unpack_uint((__unpacked)->yuv.writeback_block_format, &__tmp_packed.opaque[0], 42, 43); \
   ...
   __gen_unpack_uint((__unpacked)->yuv.writeback_sampling_mode, &__tmp_packed.opaque[0], 61, 62); \
   __gen_unpack_uint((__unpacked)->yuv.clean_pixel_write_enable, &__tmp_packed.opaque[0], 63, 63); \
   __gen_unpack_uint((__unpacked)->yuv.preload_enable, &__tmp_packed.opaque[0], 64, 64); \
   __gen_unpack_uint((__unpacked)->yuv.unload_enable, &__tmp_packed.opaque[0], 65, 65); \
   __gen_unpack_uint((__unpacked)->yuv.preload_format, &__tmp_packed.opaque[0], 67, 71); \
   __gen_unpack_uint((__unpacked)->yuv.preload_endianness, &__tmp_packed.opaque[0], 72, 73); \
   __gen_unpack_uint((__unpacked)->yuv.preload_block_format, &__tmp_packed.opaque[0], 74, 75); \
   __gen_unpack_uint((__unpacked)->yuv.preload_msaa, &__tmp_packed.opaque[0], 76, 77); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k5, &__tmp_packed.opaque[0], 80, 87); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k6, &__tmp_packed.opaque[0], 88, 88); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k7_clamp, &__tmp_packed.opaque[0], 89, 90); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k8, &__tmp_packed.opaque[0], 91, 91); \
   __gen_unpack_uint((__unpacked)->yuv.conv_disable, &__tmp_packed.opaque[0], 95, 95); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k1, &__tmp_packed.opaque[0], 96, 103); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k2, &__tmp_packed.opaque[0], 104, 111); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k3, &__tmp_packed.opaque[0], 112, 119); \
   __gen_unpack_uint((__unpacked)->yuv.conv_k4, &__tmp_packed.opaque[0], 120, 127); \
   ...
   __gen_unpack_uint((__unpacked)->afbc_rgb.writeback_endianness, &__tmp_packed.opaque[0], 40, 41); \
   __gen_unpack_uint((__unpacked)->afbc_rgb.writeback_block_format, &__tmp_packed.opaque[0], 42, 43); \
   ...
   __gen_unpack_uint((__unpacked)->afbc_rgb.writeback_sampling_mode, &__tmp_packed.opaque[0], 61, 62); \
   ...
   __gen_unpack_uint((__unpacked)->afbc_rgb.sparse, &__tmp_packed.opaque[0], 240, 240); \
...
static_assert(offsetof(struct mali_framebuffer_packed, TILER) == 56, "");
static_assert(offsetof(struct mali_framebuffer_packed, TILER_WEIGHTS) == 96, "");
