...
do { \
   ...
   if (__tmp_packed.opaque[0] & 0xe606f400) fprintf(stderr, "XXX: Invalid field of Renderer Properties unpacked at word 0\n"); \
...
do { \
   ...
   if (__tmp_packed.opaque[4] & 0xe606f400) fprintf(stderr, "XXX: Invalid field of Renderer State unpacked at word 4\n"); \
...
struct MALI_ZS_TARGET {
   ...
   uint64_t                             row_stride;
   uint64_t                             surface_stride;
   uint64_t                             preload_base;
   uint64_t                             preload_row_stride;
   uint64_t                             preload_surface_stride;
};
...
do { \
   ...
   __tmp_packed.opaque[10] = 0; \
   __tmp_packed.opaque[11] = 0; \
   __tmp_packed.opaque[12] = util_bitpack_uint((__unpacked)->preload_base, 0, 63); \
   __tmp_packed.opaque[13] = util_bitpack_uint((__unpacked)->preload_base, 0, 63) >> 32; \
   __tmp_packed.opaque[14] = util_bitpack_uint((__unpacked)->preload_row_stride, 0, 31); \
   __tmp_packed.opaque[15] = util_bitpack_uint((__unpacked)->preload_surface_stride, 0, 31); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xfffffa00) fprintf(stderr, "XXX: Invalid field of ZS Target unpacked at word 3\n"); \
   ...
   __gen_unpack_uint((__unpacked)->preload_base, &__tmp_packed.opaque[0], 384, 447); \
   __gen_unpack_uint((__unpacked)->preload_row_stride, &__tmp_packed.opaque[0], 448, 479); \
   __gen_unpack_uint((__unpacked)->preload_surface_stride, &__tmp_packed.opaque[0], 480, 511); \
} while (0);
...
MALI_ZS_TARGET_print(FILE *fp, const struct MALI_ZS_TARGET * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sRow Stride: 0x%" PRIx64 "\n", indent, "", values->row_stride);
   fprintf(fp, "%*sSurface Stride: 0x%" PRIx64 "\n", indent, "", values->surface_stride);
   fprintf(fp, "%*sPreload Base: 0x%" PRIx64 "\n", indent, "", values->preload_base);
   fprintf(fp, "%*sPreload Row Stride: 0x%" PRIx64 "\n", indent, "", values->preload_row_stride);
   fprintf(fp, "%*sPreload Surface Stride: 0x%" PRIx64 "\n", indent, "", values->preload_surface_stride);
}
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xfffffa00) fprintf(stderr, "XXX: Invalid field of AFBC ZS Target unpacked at word 3\n"); \
...
do { \
   ...
   __tmp_packed.opaque[ 3] = util_bitpack_uint((__unpacked)->zs.write_format, 0, 3) | \
            ...
            util_bitpack_uint((__unpacked)->afbc_zs.big_endian, 8, 8) | \
   ...
   __tmp_packed.opaque[12] = util_bitpack_uint((__unpacked)->zs.preload_base, 0, 63); \
   __tmp_packed.opaque[13] = util_bitpack_uint((__unpacked)->zs.preload_base, 0, 63) >> 32; \
   __tmp_packed.opaque[14] = util_bitpack_uint((__unpacked)->zs.preload_row_stride, 0, 31); \
   __tmp_packed.opaque[15] = util_bitpack_uint((__unpacked)->zs.preload_surface_stride, 0, 31); \
   *(__packed) = __tmp_packed; \
} while (0);
...
do { \
   ...
   if (__tmp_packed.opaque[3] & 0xff00fa00) fprintf(stderr, "XXX: Invalid field of ZS CRC Extension unpacked at word 3\n"); \
   ...
   __gen_unpack_uint((__unpacked)->zs.preload_base, &__tmp_packed.opaque[0], 384, 447); \
   __gen_unpack_uint((__unpacked)->zs.preload_row_stride, &__tmp_packed.opaque[0], 448, 479); \
   __gen_unpack_uint((__unpacked)->zs.preload_surface_stride, &__tmp_packed.opaque[0], 480, 511); \
   ...
   __gen_unpack_uint((__unpacked)->afbc_zs.big_endian, &__tmp_packed.opaque[0], 104, 104); \
...
do { \
   ...
   __tmp_packed.opaque[ 1] = util_bitpack_uint((__unpacked)->rgb.write_enable, 0, 0) | \
            ...
            util_bitpack_uint((__unpacked)->afbc_yuv.writeback_endianness, 8, 9) | \
            util_bitpack_uint((__unpacked)->afbc_yuv.writeback_block_format, 10, 11) | \
...
do { \
   ...
   __gen_unpack_uint((__unpacked)->afbc_yuv.writeback_endianness, &__tmp_packed.opaque[0], 40, 41); \
   __gen_unpack_uint((__unpacked)->afbc_yuv.writeback_block_format, &__tmp_packed.opaque[0], 42, 43); \
